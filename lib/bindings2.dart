...
class NativeLibrary {
  ...
  GoSlice generateValueKeyMessage(
    GoSlice clientRandom,
    GoSlice serverRandom,
    GoSlice publicKey,
  ) {
    return _generateValueKeyMessage(
      clientRandom,
      serverRandom,
      publicKey,
    );
  ...
  late final _generateValueKeyMessagePtr =
      _lookup<ffi.NativeFunction<GoSlice Function(GoSlice, GoSlice, GoSlice)>>(
          'generateValueKeyMessage');
  late final _generateValueKeyMessage = _generateValueKeyMessagePtr
      .asFunction<GoSlice Function(GoSlice, GoSlice, GoSlice)>();
  ...
  late final _PHashPtr = _lookup<
      ffi
      .NativeFunction<PHash_return Function(GoSlice, GoSlice, GoInt)>>('PHash');
  late final _PHash =
      _PHashPtr.asFunction<PHash_return Function(GoSlice, GoSlice, int)>();

  VerifyFinishedData_return VerifyFinishedData(
    GoSlice handshakeMessages,
    GoSlice serverMasterSecret,
  ) {
    return _VerifyFinishedData(
      handshakeMessages,
      serverMasterSecret,
    );
  }

  late final _VerifyFinishedDataPtr = _lookup<
      ffi.NativeFunction<
          VerifyFinishedData_return Function(
              GoSlice, GoSlice)>>('VerifyFinishedData');
  late final _VerifyFinishedData = _VerifyFinishedDataPtr.asFunction<
      VerifyFinishedData_return Function(GoSlice, GoSlice)>();

  GenerateServerCertificate_return GenerateServerCertificate(
    GoString cn,
  ) {
    return _GenerateServerCertificate(
      cn,
    );
  }

  late final _GenerateServerCertificatePtr = _lookup<
          ffi
          .NativeFunction<GenerateServerCertificate_return Function(GoString)>>(
      'GenerateServerCertificate');
  late final _GenerateServerCertificate = _GenerateServerCertificatePtr
      .asFunction<GenerateServerCertificate_return Function(GoString)>();

  GenerateCurveKeypair_return GenerateCurveKeypair() {
    return _GenerateCurveKeypair();
  }

  late final _GenerateCurveKeypairPtr =
      _lookup<ffi.NativeFunction<GenerateCurveKeypair_return Function()>>(
          'GenerateCurveKeypair');
  late final _GenerateCurveKeypair = _GenerateCurveKeypairPtr.asFunction<
      GenerateCurveKeypair_return Function()>();

  GenerateKeySignature_return GenerateKeySignature(
    GoSlice clientRandom,
    GoSlice serverRandom,
    GoSlice publicKey,
    GoSlice privateKey,
  ) {
    return _GenerateKeySignature(
      clientRandom,
      serverRandom,
      publicKey,
      privateKey,
  ...
  late final _GenerateKeySignaturePtr = _lookup<
      ffi.NativeFunction<
          GenerateKeySignature_return Function(
              GoSlice, GoSlice, GoSlice, GoSlice)>>('GenerateKeySignature');
  late final _GenerateKeySignature = _GenerateKeySignaturePtr.asFunction<
      GenerateKeySignature_return Function(
          GoSlice, GoSlice, GoSlice, GoSlice)>();

  GoString GetCertificateFingerprintFromBytes(
    GoSlice certificate,
  ) {
    return _GetCertificateFingerprintFromBytes(
      certificate,
    );
  }

  late final _GetCertificateFingerprintFromBytesPtr =
      _lookup<ffi.NativeFunction<GoString Function(GoSlice)>>(
          'GetCertificateFingerprintFromBytes');
  late final _GetCertificateFingerprintFromBytes =
      _GetCertificateFingerprintFromBytesPtr.asFunction<
          GoString Function(GoSlice)>();

  GeneratePreMasterSecret_return GeneratePreMasterSecret(
    GoSlice publicKey,
    GoSlice privateKey,
  ) {
    return _GeneratePreMasterSecret(
      publicKey,
      privateKey,
    );
  }

  late final _GeneratePreMasterSecretPtr = _lookup<
      ffi.NativeFunction<
          GeneratePreMasterSecret_return Function(
              GoSlice, GoSlice)>>('GeneratePreMasterSecret');
  late final _GeneratePreMasterSecret = _GeneratePreMasterSecretPtr.asFunction<
      GeneratePreMasterSecret_return Function(GoSlice, GoSlice)>();

  GoInterface VerifyCertificate(
    GoSlice handshakeMessages,
  ...
  late final _VerifyCertificatePtr = _lookup<
          ffi.NativeFunction<GoInterface Function(GoSlice, GoSlice, GoSlice)>>(
      'VerifyCertificate');
  late final _VerifyCertificate = _VerifyCertificatePtr.asFunction<
      GoInterface Function(GoSlice, GoSlice, GoSlice)>();
}
...
final class PHash_return extends ffi.Struct {
  external GoSlice r0;

  external GoInterface r1;
}

final class VerifyFinishedData_return extends ffi.Struct {
  external GoSlice r0;

  external GoInterface r1;
}

final class GenerateServerCertificate_return extends ffi.Struct {
  external GoSlice r0;

  external GoSlice r1;

  external GoInterface r2;
}

final class GenerateCurveKeypair_return extends ffi.Struct {
  external GoSlice r0;
...
final class GenerateKeySignature_return extends ffi.Struct {
  external GoSlice r0;

  external GoInterface r1;
}

final class GeneratePreMasterSecret_return extends ffi.Struct {
  external GoSlice r0;
