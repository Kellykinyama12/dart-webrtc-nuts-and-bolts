...
extern "C"
{
    ...
    extern int GenerateKeySignature(unsigned char *clientRandom, size_t clientLen, unsigned char *serverRandom, size_t serverLen, unsigned char *publicKey, size_t publicLen, unsigned char *privateKey, size_t privateKeyLen, unsigned char **signed, size_t *signedLen);
